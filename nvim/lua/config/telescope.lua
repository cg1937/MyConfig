...
local function my_scroll_results_page(prompt_bufnr, direction)
    ...
    local status_updater =
        picker:get_status_updater(picker.prompt_win, picker.prompt_bufnr)

    picker.layout_config.scroll_speed =
        vim.api.nvim_win_get_height(state.layout.results.winid)
