		...
		mappings = {
			i = {
				...
				["<Up>"] = function(prompt_bufnr)
					my_move_selection(prompt_bufnr, -1)
				end,
				["<Down>"] = function(prompt_bufnr)
					my_move_selection(prompt_bufnr, 1)
				end,
				["<PageUp>"] = function(prompt_bufnr)
					my_scroll_results_page(prompt_bufnr, -1)
				end,
				...
				["<C-PageUp>"] = function(prompt_bufnr)
					my_scroll_preview_page(prompt_bufnr, -1)
				end,
				["<C-PageDown>"] = function(prompt_bufnr)
					my_scroll_preview_page(prompt_bufnr, 1)
				end,
...
vim.keymap.set("v", "<leader>fr", "<cmd>Telescope git_bcommits_range<CR>", default_options)
vim.keymap.set("n", "<leader>fg", "<cmd>Telescope grep_string<CR>", default_options)
vim.keymap.set("n", "<leader>fk", my_lsp_references, default_options)
vim.keymap.set("n", "<leader>fs", my_live_grep, default_options)
vim.keymap.set("n", "<leader>fd", my_lsp_dynamic_workspace_symbols, default_options)
